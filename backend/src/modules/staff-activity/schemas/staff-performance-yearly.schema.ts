...
export class StaffPerformanceYearly {
...
export const StaffPerformanceYearlySchema =
  SchemaFactory.createForClass(StaffPerformanceYearly);

StaffPerformanceYearlySchema.index({ staffId: 1, periodStart: 1 }, { unique: true });
