...
export const StaffPerformanceDailySchema =
  SchemaFactory.createForClass(StaffPerformanceDaily);

StaffPerformanceDailySchema.index({ staffId: 1, periodStart: 1 }, { unique: true });
