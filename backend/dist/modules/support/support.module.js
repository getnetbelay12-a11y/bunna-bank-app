...
const support_customer_controller_1 = require("./support-customer.controller");
...
exports.SupportModule = SupportModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [support_controller_1.SupportController, support_customer_controller_1.SupportCustomerController],
    })
], SupportModule);
