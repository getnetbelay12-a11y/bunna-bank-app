...
export declare class SupportConsoleController {
    private readonly chatService;
    constructor(chatService: ChatService);
    getOpenChats(): Promise<import("../chat/interfaces").ChatConversationResult[]>;
    ...
    getChat(conversationId: string): Promise<import("../chat/interfaces").ChatConversationDetailResult>;
