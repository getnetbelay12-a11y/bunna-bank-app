...
], Branch.prototype, "districtId", void 0);
__decorate([
...
exports.Branch = Branch = __decorate([
    (0, mongoose_1.Schema)({ collection: 'branches', timestamps: true, versionKey: false })
], Branch);
exports.BranchSchema = mongoose_1.SchemaFactory.createForClass(Branch);
exports.BranchSchema.index({ districtId: 1, name: 1 });
exports.BranchSchema.index({ region: 1, city: 1, name: 1 });
