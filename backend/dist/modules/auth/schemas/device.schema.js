...
], Device.prototype, "memberId", void 0);
__decorate([
...
], Device.prototype, "rememberDevice", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: false }),
    __metadata("design:type", Boolean)
], Device.prototype, "biometricEnabled", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", Date)
], Device.prototype, "lastLoginAt", void 0);
exports.Device = Device = __decorate([
    (0, mongoose_1.Schema)({ collection: 'devices', timestamps: true, versionKey: false })
], Device);
exports.DeviceSchema = mongoose_1.SchemaFactory.createForClass(Device);
exports.DeviceSchema.index({ memberId: 1, deviceId: 1 }, { unique: true });
