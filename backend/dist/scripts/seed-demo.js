...
const identity_verification_schema_1 = require("../modules/identity-verification/schemas/identity-verification.schema");
const insurance_policy_schema_1 = require("../modules/insurance/schemas/insurance-policy.schema");
const member_profile_schema_1 = require("../modules/member-profiles/schemas/member-profile.schema");
...
const staff_permissions_1 = require("../modules/staff/staff-permissions");
...
const notification_campaign_schema_1 = require("../modules/notifications/schemas/notification-campaign.schema");
const notification_log_schema_1 = require("../modules/notifications/schemas/notification-log.schema");
...
const vote_response_schema_1 = require("../modules/voting/schemas/vote-response.schema");
...
const recommendation_schema_1 = require("../modules/recommendations/schemas/recommendation.schema");
const recommendation_event_schema_1 = require("../modules/recommendations/schemas/recommendation-event.schema");
const atm_card_request_schema_1 = require("../modules/service-placeholders/schemas/atm-card-request.schema");
const autopay_setting_schema_1 = require("../modules/service-placeholders/schemas/autopay-setting.schema");
const service_request_schema_1 = require("../modules/service-requests/schemas/service-request.schema");
const service_request_event_schema_1 = require("../modules/service-requests/schemas/service-request-event.schema");
const service_request_types_1 = require("../modules/service-requests/service-request.types");
const card_schema_1 = require("../modules/card-management/schemas/card.schema");
const card_request_schema_1 = require("../modules/card-management/schemas/card-request.schema");
const card_event_schema_1 = require("../modules/card-management/schemas/card-event.schema");
const card_management_types_1 = require("../modules/card-management/card-management.types");
...
const audit_log_schema_1 = require("../modules/audit/schemas/audit-log.schema");
async function run() {
    const mongoUri = process.env.MONGODB_URI ?? 'mongodb://localhost:27017/bunna_bank_app';
    const demoNow = new Date();
    const schoolPaymentDueAnchor = new Date(demoNow.getTime() - 29 * 24 * 60 * 60 * 1000);
    ...
    const MemberProfileModel = createModel(member_profile_schema_1.MemberProfileEntity.name, member_profile_schema_1.MemberProfileSchema);
    const IdentityVerificationModel = createModel(identity_verification_schema_1.IdentityVerification.name, identity_verification_schema_1.IdentityVerificationSchema);
    ...
    const InsurancePolicyModel = createModel(insurance_policy_schema_1.InsurancePolicy.name, insurance_policy_schema_1.InsurancePolicySchema);
    const AutopaySettingModel = createModel(autopay_setting_schema_1.AutopaySetting.name, autopay_setting_schema_1.AutopaySettingSchema);
    const AtmCardRequestModel = createModel(atm_card_request_schema_1.AtmCardRequest.name, atm_card_request_schema_1.AtmCardRequestSchema);
    const ServiceRequestModel = createModel(service_request_schema_1.ServiceRequest.name, service_request_schema_1.ServiceRequestSchema);
    const ServiceRequestEventModel = createModel(service_request_event_schema_1.ServiceRequestEvent.name, service_request_event_schema_1.ServiceRequestEventSchema);
    const CardModel = createModel(card_schema_1.Card.name, card_schema_1.CardSchema);
    const CardRequestModel = createModel(card_request_schema_1.CardRequest.name, card_request_schema_1.CardRequestSchema);
    const CardEventModel = createModel(card_event_schema_1.CardEvent.name, card_event_schema_1.CardEventSchema);
    const NotificationModel = createModel(notification_schema_1.Notification.name, notification_schema_1.NotificationSchema);
    const NotificationCampaignModel = createModel(notification_campaign_schema_1.NotificationCampaign.name, notification_campaign_schema_1.NotificationCampaignSchema);
    const NotificationLogModel = createModel(notification_log_schema_1.NotificationLog.name, notification_log_schema_1.NotificationLogSchema);
    ...
    const VoteResponseModel = createModel(vote_response_schema_1.VoteResponse.name, vote_response_schema_1.VoteResponseSchema);
    ...
    const RecommendationModel = createModel(recommendation_schema_1.Recommendation.name, recommendation_schema_1.RecommendationSchema);
    const RecommendationEventModel = createModel(recommendation_event_schema_1.RecommendationEvent.name, recommendation_event_schema_1.RecommendationEventSchema);
    const AuditLogModel = createModel(audit_log_schema_1.AuditLog.name, audit_log_schema_1.AuditLogSchema);
    await Promise.all([
    ...
    const woldiaDistrictId = new mongoose_1.Types.ObjectId();
    const jimmaDistrictId = new mongoose_1.Types.ObjectId();
    const mekeleDistrictId = new mongoose_1.Types.ObjectId();
    ...
    const dessieBranchId = new mongoose_1.Types.ObjectId();
    const jimmaBranchId = new mongoose_1.Types.ObjectId();
    const mekeleBranchId = new mongoose_1.Types.ObjectId();
    ...
    const branchKycOfficerId = new mongoose_1.Types.ObjectId();
    const debreMarkosOfficerId = new mongoose_1.Types.ObjectId();
    const dessieOfficerId = new mongoose_1.Types.ObjectId();
    await StaffModel.insertMany([
        {
            ...
            permissions: (0, staff_permissions_1.deriveStaffPermissions)(enums_1.UserRole.ADMIN),
        ...
        },
        {
            ...
            permissions: (0, staff_permissions_1.deriveStaffPermissions)(enums_1.UserRole.HEAD_OFFICE_MANAGER),
            passwordHash: 'demo-pass',
            isActive: true,
        },
        {
            ...
            districtId: bahirDarDistrictId,
            permissions: (0, staff_permissions_1.deriveStaffPermissions)(enums_1.UserRole.DISTRICT_MANAGER),
            passwordHash: 'demo-pass',
            isActive: true,
        },
        {
            ...
            districtId: bahirDarDistrictId,
            permissions: (0, staff_permissions_1.deriveStaffPermissions)(enums_1.UserRole.BRANCH_MANAGER),
            passwordHash: 'demo-pass',
            isActive: true,
        },
        {
            ...
            branchId: bahirDarBranchId,
            districtId: bahirDarDistrictId,
            permissions: (0, staff_permissions_1.deriveStaffPermissions)(enums_1.UserRole.SUPPORT_AGENT),
            passwordHash: 'demo-pass',
            isActive: true,
        },
        {
            ...
            branchId: bahirDarBranchId,
            districtId: bahirDarDistrictId,
            permissions: (0, staff_permissions_1.deriveStaffPermissions)(enums_1.UserRole.LOAN_OFFICER),
            passwordHash: 'demo-pass',
            isActive: true,
        },
        {
    ...
    const fourthRegularMemberId = new mongoose_1.Types.ObjectId();
    const fifthRegularMemberId = new mongoose_1.Types.ObjectId();
    const sixthRegularMemberId = new mongoose_1.Types.ObjectId();
    const regularMemberProfileId = new mongoose_1.Types.ObjectId();
    const fifthRegularMemberProfileId = new mongoose_1.Types.ObjectId();
    ...
    const fourthRegularSavingsId = new mongoose_1.Types.ObjectId();
    const fifthRegularSavingsId = new mongoose_1.Types.ObjectId();
    const sixthRegularSavingsId = new mongoose_1.Types.ObjectId();
    ...
    const branchBusinessLoanId = new mongoose_1.Types.ObjectId();
    ...
    const sixthRegularLoanId = new mongoose_1.Types.ObjectId();
    const bahirDarEscalatedConversationId = new mongoose_1.Types.ObjectId();
    await LoanModel.insertMany([
        ...
        },
        {
            ...
            termMonths: 24,
            purpose: 'Renovation',
            status: enums_1.LoanStatus.CLOSED,
            currentLevel: enums_1.LoanWorkflowLevel.HEAD_OFFICE,
        ...
        },
        {
            ...
            status: enums_1.LoanStatus.NEEDS_MORE_INFO,
            currentLevel: enums_1.LoanWorkflowLevel.BRANCH,
            assignedToStaffId: debreMarkosOfficerId,
            deficiencyReasons: [
    ...
    const schoolAutopayId = new mongoose_1.Types.ObjectId();
    const rentAutopayId = new mongoose_1.Types.ObjectId();
    const electricityAutopayId = new mongoose_1.Types.ObjectId();
    const waterAutopayId = new mongoose_1.Types.ObjectId();
    ...
    const atmCardServiceRequestId = new mongoose_1.Types.ObjectId();
    const phoneUpdateServiceRequestId = new mongoose_1.Types.ObjectId();
    const accountRelationshipServiceRequestId = new mongoose_1.Types.ObjectId();
    const paymentDisputeServiceRequestId = new mongoose_1.Types.ObjectId();
    const shareholderCardId = new mongoose_1.Types.ObjectId();
    const shareholderReplacementRequestId = new mongoose_1.Types.ObjectId();
    const fifthMemberCardId = new mongoose_1.Types.ObjectId();
    const fifthMemberCardRequestId = new mongoose_1.Types.ObjectId();
    await ServiceRequestModel.insertMany([
        {
            ...
            type: service_request_types_1.ServiceRequestType.ATM_CARD_REQUEST,
            title: 'ATM card request',
            description: 'Request for ATM card issuance with branch pickup and verified identity documents.',
            payload: {
                preferredBranch: 'Bahir Dar Branch',
                cardType: 'debit',
            ...
            status: service_request_types_1.ServiceRequestStatus.UNDER_REVIEW,
        ...
        },
        {
            ...
            type: service_request_types_1.ServiceRequestType.PHONE_UPDATE,
            title: 'Phone number update request',
            description: 'Member requested to replace the phone number linked to the account.',
            payload: {
            ...
            status: service_request_types_1.ServiceRequestStatus.AWAITING_CUSTOMER,
        ...
        },
        {
            ...
            districtId: bahirDarDistrictId,
            branchName: 'Bahir Dar Branch',
            type: service_request_types_1.ServiceRequestType.ACCOUNT_RELATIONSHIP,
            title: 'Joint account relationship request',
            description: 'Member requested to add a spouse relationship for joint account servicing.',
            payload: {
        ...
        },
        {
            ...
            type: service_request_types_1.ServiceRequestType.PAYMENT_DISPUTE,
            title: 'Payment dispute for SCH-2026-014',
            description: 'Member reported a duplicated school fee payment and requested reversal review.',
            payload: {
    ...
    await ServiceRequestEventModel.insertMany([
        {
            ...
            eventType: 'created',
            toStatus: service_request_types_1.ServiceRequestStatus.SUBMITTED,
        ...
        },
        {
            ...
            fromStatus: service_request_types_1.ServiceRequestStatus.SUBMITTED,
            toStatus: service_request_types_1.ServiceRequestStatus.UNDER_REVIEW,
        ...
        },
        {
            ...
            eventType: 'status_updated',
            fromStatus: service_request_types_1.ServiceRequestStatus.SUBMITTED,
            toStatus: service_request_types_1.ServiceRequestStatus.AWAITING_CUSTOMER,
    ...
    await CardModel.insertMany([
        {
            ...
            cardType: 'Debit Card',
            last4: '4821',
            status: card_management_types_1.CardStatus.ACTIVE,
            preferredBranch: 'Bahir Dar Branch',
            channelControls: {
                atm: true,
                pos: true,
        ...
        },
        {
            ...
            memberId: fifthRegularMemberId,
            cardType: 'ATM Card',
            status: card_management_types_1.CardStatus.PENDING_ISSUE,
    ...
    await CardRequestModel.insertMany([
        {
            ...
            requestType: card_management_types_1.CardRequestType.REPLACEMENT,
            status: card_management_types_1.CardRequestStatus.COMPLETED,
            preferredBranch: 'Bahir Dar Branch',
        ...
        },
        {
            ...
            requestType: card_management_types_1.CardRequestType.NEW_ISSUE,
            status: card_management_types_1.CardRequestStatus.UNDER_REVIEW,
            preferredBranch: 'Dessie Branch',
    ...
    await NotificationModel.insertMany([
        ...
        },
        {
            ...
            userId: shareholderMemberId,
            userRole: enums_1.UserRole.SHAREHOLDER_MEMBER,
            type: enums_1.NotificationType.SERVICE_REQUEST,
            status: enums_1.NotificationStatus.SENT,
        ...
        },
        {
            ...
            userRole: enums_1.UserRole.MEMBER,
            type: enums_1.NotificationType.INSURANCE,
        ...
        },
        {
            ...
            message: 'Your payment dispute needs a receipt upload before review can continue.',
            entityType: 'service_request',
    ...
    const loanReminderCampaignId = new mongoose_1.Types.ObjectId();
    const insuranceCampaignId = new mongoose_1.Types.ObjectId();
    ...
    const draftVoteId = new mongoose_1.Types.ObjectId();
    const publishedVoteId = new mongoose_1.Types.ObjectId();
    const candidateAOptionId = new mongoose_1.Types.ObjectId();
    const candidateBOptionId = new mongoose_1.Types.ObjectId();
    const candidateCOptionId = new mongoose_1.Types.ObjectId();
    const draftApproveOptionId = new mongoose_1.Types.ObjectId();
    const draftHoldOptionId = new mongoose_1.Types.ObjectId();
    const publishedRatifiedOptionId = new mongoose_1.Types.ObjectId();
    await VoteModel.insertMany([
        ...
        },
        {
            ...
            type: 'governance',
            status: enums_1.VoteStatus.PUBLISHED,
    ...
    const debreMarkosOpenConversationId = new mongoose_1.Types.ObjectId();
    const debreMarkosKycConversationId = new mongoose_1.Types.ObjectId();
    ...
    await AuditLogModel.insertMany([
        ...
        },
        {
            ...
            actorRole: enums_1.UserRole.HEAD_OFFICE_MANAGER,
        ...
        },
        {
            ...
            actorRole: enums_1.UserRole.BRANCH_MANAGER,
        ...
        },
        {
            ...
            actorRole: enums_1.UserRole.SUPPORT_AGENT,
        ...
        },
        {
            ...
            actorRole: enums_1.UserRole.DISTRICT_MANAGER,
...
function buildDailyPerformanceSeries(configs, referenceDate) {
    const rows = [];
